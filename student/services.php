    ...
    <section class="services py-5">
        <div class="container py-lg-5 py-3">
            ...
            <div class="row service-grids">
                <div class="col-lg-3 col-md-6 service-grid1">
                    <h3>A Hostel</h3>
                    <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mt-lg-0 mt-5 service-grid1">
                    <h3>C Hostel</h3>
                    <div class="row">
                        <div class="col-md-3 col-2">
                            <h4>3 yr</h4>
                ...
                <div class="row wthree_banner_bottom_right_grids pr-sm-3">
                    <div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
                        <div class="view view-tenth">
                            ...
                            <div class="mask">
                                <a href="application_form.php?id=A"><img src="../web_home/images/s1.jpg"
                    ...
                    <div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
                        <div class="view view1 view-tenth">
                            ...
                            <div class="mask">
                                <a href="application_form.php?id=B"><img src="../web_home/images/s2.jpg"
                                        class="img-responsive" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
                        <div class="view view2 view-tenth">
                            ...
                            <div class="mask">
                                <a href="application_form.php?id=C"><img src="../web_home/images/s3.jpg"
                                        class="img-responsive" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
                        <div class="view view3 view-tenth">
                            ...
                            <div class="mask">
                                <a href="application_form.php?id=D"><img src="../web_home/images/s4.jpg"
                                        class="img-responsive" alt="" /></a>
                            </div>
                        </div>
                    </div>
